...
public class ReservaController {
    ...
    public ResponseEntity<List<Reserva>> obtenerPorProductoId(@PathVariable Long productoId) {
        List<Reserva> reservas = reservaService.obtenerPorProductoId(productoId);
        return ResponseEntity.ok(reservas);
    }
